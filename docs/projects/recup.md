...
## Talks and Tutorials
- Kilic, O. O., Wang, T., Turilli, M., Titov, M., Merzky, A., Pouchard, L. C., & Jha, S. (2025, July). *Workflow Mini-Apps: Evaluating Performance Reproducibility in Scientific Workflows*. Tutorial presented at ACM Conference on Reproducibility and Replicability (ACM REP 2025). [Tutorial Materials](https://github.com/radical-cybertools/tutorials/wiki/ACM-REP-Tutorials-2025)
- Kilic, O. O., & Wang, T. (2026, May). *Classification and Modeling the Performance and Scaling of Scientific Workflows with Resource-efficient Workflow Mini-apps*. Presented at 28th Conference on Computing in High Energy and Nuclear Physics (CHEP 2026). [Talk Details](https://indico.cern.ch/event/1471803/contributions/6966773/)
